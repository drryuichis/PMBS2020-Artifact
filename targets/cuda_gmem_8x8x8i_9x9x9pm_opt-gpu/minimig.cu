...
#define N_THREADS_THIRD_DIM 8
#define N_THREADS_PML_I_DIM 9
#define N_THREADS_PML_J_DIM 9
#define N_THREADS_PML_K_DIM 9
...
extern "C" void target(
    ...
    dim3 threadsPerBlock_inner(N_THREADS_THIRD_DIM, N_THREADS_PLANE_DIM, N_THREADS_PLANE_DIM);
    dim3 threadsPerBlock(N_THREADS_PML_K_DIM, N_THREADS_PML_J_DIM, N_THREADS_PML_I_DIM);
    ...
    for (uint istep = 1; istep <= nsteps; ++istep) {
        ...
        dim3 n_block_front(
            (z2-z1+N_THREADS_PML_K_DIM-1) / N_THREADS_PML_K_DIM,
            (ny+N_THREADS_PML_J_DIM-1) / N_THREADS_PML_J_DIM,
            (nx+N_THREADS_PML_I_DIM-1) / N_THREADS_PML_I_DIM);
        ...
        dim3 n_block_top(
            (z4-z3+N_THREADS_PML_K_DIM-1) / N_THREADS_PML_K_DIM,
            (y2-y1+N_THREADS_PML_J_DIM-1) / N_THREADS_PML_J_DIM,
            (nx+N_THREADS_PML_I_DIM-1) / N_THREADS_PML_I_DIM);
        ...
        dim3 n_block_left(
            (z4-z3+N_THREADS_PML_K_DIM-1) / N_THREADS_PML_K_DIM,
            (y4-y3+N_THREADS_PML_J_DIM-1) / N_THREADS_PML_J_DIM,
            (x2-x1+N_THREADS_PML_I_DIM-1) / N_THREADS_PML_I_DIM);
        ...
        dim3 n_block_right(
            (z4-z3+N_THREADS_PML_K_DIM-1) / N_THREADS_PML_K_DIM,
            (y4-y3+N_THREADS_PML_J_DIM-1) / N_THREADS_PML_J_DIM,
            (x6-x5+N_THREADS_PML_I_DIM-1) / N_THREADS_PML_I_DIM);
        ...
        dim3 n_block_bottom(
            (z4-z3+N_THREADS_PML_K_DIM-1) / N_THREADS_PML_K_DIM,
            (y6-y5+N_THREADS_PML_J_DIM-1) / N_THREADS_PML_J_DIM,
            (nx+N_THREADS_PML_I_DIM-1) / N_THREADS_PML_I_DIM);
        ...
        dim3 n_block_back(
            (z6-z5+N_THREADS_PML_K_DIM-1) / N_THREADS_PML_K_DIM,
            (ny+N_THREADS_PML_J_DIM-1) / N_THREADS_PML_J_DIM,
            (nx+N_THREADS_PML_I_DIM-1) / N_THREADS_PML_I_DIM);
