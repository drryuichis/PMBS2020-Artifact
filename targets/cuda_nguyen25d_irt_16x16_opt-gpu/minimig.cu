            ...
            phi[IDX3(i,j,k)] = __fdiv_rn(
                    __fsub_rn(
                        ...
                        __fmul_rn(
                            ...
                            __fsub_rn(s_u[Z(z+1)][suj][suk], s_u[Z(z-1+nz_s_u)][suj][suk])
                        ), hdx_2,
                        __fmaf_rn(
                        __fmul_rn(
